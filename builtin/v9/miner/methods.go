...
var Methods = map[abi.MethodNum]builtin.MethodMeta{
	...
	17: builtin.NewMethodMeta("ConfirmSectorProofsValid", *new(func(*ConfirmSectorProofsParams) *abi.EmptyValue)),  // ConfirmSectorProofsValid
	...
	21: builtin.NewMethodMeta("ConfirmUpdateWorkerKey", *new(func(*abi.EmptyValue) *abi.EmptyValue)),               // ConfirmUpdateWorkerKey
