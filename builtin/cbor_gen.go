...
var lengthBufEmptyState = []byte{128}

func (t *EmptyState) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}
	if _, err := w.Write(lengthBufEmptyState); err != nil {
		return err
	}
...
func (t *EmptyState) UnmarshalCBOR(r io.Reader) error {
	*t = EmptyState{}
