...
var Methods = map[abi.MethodNum]builtin.MethodMeta{
	...
	builtin.MustGenerateExportedMethodNum("AddVerifiedClient"): {"AddVerifiedClientExported", *new(func(*AddVerifiedClientParams) *abi.EmptyValue)}, // AddVerifiedClientExported
	...
	builtin.MustGenerateExportedMethodNum("RemoveExpiredAllocations"): {"RemoveExpiredAllocationsExported", *new(func(*RemoveExpiredAllocationsParams) *RemoveExpiredAllocationsReturn)}, // RemoveExpiredAllocationsExported
	...
	builtin.MustGenerateExportedMethodNum("GetClaims"): {"GetClaimsExported", *new(func(*GetClaimsParams) *GetClaimsReturn)}, // GetClaimsExported
	11: {"ExtendClaimTerms", *new(func(*ExtendClaimTermsParams) *ExtendClaimTermsReturn)}, // ExtendClaimTerms
	builtin.MustGenerateExportedMethodNum("ExtendClaimTerms"): {"ExtendClaimTermsExported", *new(func(*ExtendClaimTermsParams) *ExtendClaimTermsReturn)}, // ExtendClaimTermsExported
	12: {"RemoveExpiredClaims", *new(func(*RemoveExpiredClaimsParams) *RemoveExpiredClaimsReturn)}, // RemoveExpiredClaims
	builtin.MustGenerateExportedMethodNum("RemoveExpiredClaims"): {"RemoveExpiredClaimsExported", *new(func(*RemoveExpiredClaimsParams) *RemoveExpiredClaimsReturn)}, // RemoveExpiredClaimsExported
