...
var Methods = map[abi.MethodNum]builtin.MethodMeta{
	...
	builtin.MustGenerateExportedMethodNum("ChangeWorkerAddress"): {"ChangeWorkerAddressExported", *new(func(*ChangeWorkerAddressParams) *abi.EmptyValue)}, // ChangeWorkerAddressExported
	4: {"ChangePeerID", *new(func(*ChangePeerIDParams) *abi.EmptyValue)}, // ChangePeerID
	builtin.MustGenerateExportedMethodNum("ChangePeerID"): {"ChangePeerIDExported", *new(func(*ChangePeerIDParams) *abi.EmptyValue)}, // ChangePeerIDExported
	...
	builtin.MustGenerateExportedMethodNum("ChangeMultiaddrs"): {"ChangeMultiaddrsExported", *new(func(*ChangeMultiaddrsParams) *abi.EmptyValue)}, // ChangeMultiaddrsExported
	...
	builtin.MustGenerateExportedMethodNum("ConfirmChangeWorkerAddress"): {"ConfirmChangeWorkerAddressExported", *new(func(*abi.EmptyValue) *abi.EmptyValue)}, // ConfirmChangeWorkerAddressExported
	22: {"RepayDebt", *new(func(*abi.EmptyValue) *abi.EmptyValue)}, // RepayDebt
	builtin.MustGenerateExportedMethodNum("RepayDebt"): {"RepayDebtExported", *new(func(*abi.EmptyValue) *abi.EmptyValue)}, // RepayDebtExported
	23: {"ChangeOwnerAddress", *new(func(*address.Address) *abi.EmptyValue)}, // ChangeOwnerAddress
	builtin.MustGenerateExportedMethodNum("ChangeOwnerAddress"): {"ChangeOwnerAddressExported", *new(func(*address.Address) *abi.EmptyValue)}, // ChangeOwnerAddressExported
	...
	builtin.MustGenerateExportedMethodNum("ChangeBeneficiary"): {"ChangeBeneficiaryExported", *new(func(*ChangeBeneficiaryParams) *abi.EmptyValue)}, // ChangeBeneficiaryExported
	...
	builtin.MustGenerateExportedMethodNum("GetOwner"):             {"GetOwnerExported", *new(func(*abi.EmptyValue) *GetOwnerReturn)},                                            // GetOwnerExported
	builtin.MustGenerateExportedMethodNum("IsControllingAddress"): {"IsControllingAddressExported", *new(func(params *IsControllingAddressParams) *IsControllingAddressReturn)}, // IsControllingAddressExported
	builtin.MustGenerateExportedMethodNum("GetSectorSize"):        {"GetSectorSizeExported", *new(func(*abi.EmptyValue) *GetSectorSizeReturn)},                                  // GetSectorSizeExported
	builtin.MustGenerateExportedMethodNum("GetAvailableBalance"):  {"GetAvailableBalanceExported", *new(func(*abi.EmptyValue) *GetAvailableBalanceReturn)},                      // GetAvailableBalanceExported
	builtin.MustGenerateExportedMethodNum("GetVestingFunds"):      {"GetVestingFundsExported", *new(func(*abi.EmptyValue) *GetVestingFundsReturn)},                              // GetVestingFundsExported
	builtin.MustGenerateExportedMethodNum("GetPeerID"):            {"GetPeerIDExported", *new(func(*abi.EmptyValue) *GetPeerIDReturn)},                                          // GetPeerIDExported
	builtin.MustGenerateExportedMethodNum("GetMultiaddrs"):        {"GetMultiaddrsExported", *new(func(*abi.EmptyValue) *GetMultiAddrsReturn)},                                  // GetMultiaddrsExported
}
