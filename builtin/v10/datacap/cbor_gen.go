...
var lengthBufGranularityReturn = []byte{129}

func (t *GranularityReturn) MarshalCBOR(w io.Writer) error {
	if t == nil {
		_, err := w.Write(cbg.CborNull)
		return err
	}
	if _, err := w.Write(lengthBufGranularityReturn); err != nil {
		return err
	}
	...
	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajUnsignedInt, uint64(t.Granularity)); err != nil {
		return err
	}
...
func (t *GranularityReturn) UnmarshalCBOR(r io.Reader) error {
	*t = GranularityReturn{}
